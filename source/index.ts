...
import friendshipActions from "./channels/friendship-actions.js";
import howToTranslate from "./channels/how-to-translate.js";
import rules from "./channels/rules.js";
import updatingDailyGuides from "./channels/updating-daily-guides.js";
...
const discordDelivery = new DiscordDelivery({
	data: messageIds,
	informationChannels: [welcome, rules, friendshipActions, updatingDailyGuides, howToTranslate],
	token: DISCORD_TOKEN,
	force: FORCE,
});
